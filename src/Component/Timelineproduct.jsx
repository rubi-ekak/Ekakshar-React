                ...
                <ul class="list-inline events">
                  <li class="list-inline-item event-list">
                    <div class="px-4">
                      ...
                      <p class="text-muted para-family">
                  ...
                  <li class="list-inline-item event-list">
                    <div class="px-4">
                      ...
                      <p class="text-muted para-family">
                        ...
                        free consultation with one of our experts.During this session, we will discuss your project in more detail. 
                  ...
                  <li class="list-inline-item event-list">
                    <div class="px-4">
                      <div class="event-date bg-soft-warning">
                        step 4
                      </div>
                      ...
                      <p class="text-muted para-family">
                        ...
                        your project right away.You will be assigned project manager.
                      </p>
                      <div>
                      <button
                          type="button"
                  ...
                  <li class="list-inline-item event-list">
                    <div class="px-4">
                      <div class="event-date bg-soft-enjoy">
                        step 5
                      </div>
                      ...
                      <p class="text-muted">
                        ...
                        documentation, source files, and support.Ready to create products that make a positive difference in the world?
                      </p>
                      <div>
                      <button
                          type="button"
