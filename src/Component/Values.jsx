  ...
  return (
    <section className="main-padding ">
        ...
        <div class=" text-center box-padding animate__animated animate__fadeInUp animate__delay-5s">
          <div class="row">
            <div class="col border   rounded-4 animate__animated animate__fadeInRight animate__delay-6s" style={{maxWidth:"40%"}} >
              <Valuecard1/>
            </div>
            <div class="col border border-color rounded-4 animate__animated animate__fadeInRight animate__delay-7s" style={{maxWidth:"20%"}}>
              <Valuecard2/>
                {/* <Valuecard {...theme}/> */}
              
            </div>
            <div class="col border border-color rounded-4 animate__animated animate__fadeInRight animate__delay-8s" style={{maxWidth:"20%"}}>
              <Valuecard3/>
            </div>
            <div class="col border border-color rounded-4 animate__animated animate__fadeInRight animate__delay-8s" style={{maxWidth:"20%"}}>
              {/* <Valuecard {...theme1}/> */}
